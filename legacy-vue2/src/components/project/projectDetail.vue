...
import ArticleMenu from "@/components/blog/blogMenu.vue"
...
export default Vue.extend({
  ...
  methods: {
    ...
    getArticle() {
      ...
      ProjectApi.getArticle(this.$route.params.id, i18n.locale)
        .then((v) => {
  ...
  computed: {
    ...
    anchors(): IBlogTranslation["toc"] {
      return this.translatedArticle.toc
    },
  },
})
</script>
