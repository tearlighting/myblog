...
export default Vue.extend({
  ...
  methods: {
    getProjectList() {
      ...
      ProjectApi.getProjects({ ...this.routeInfo, type: i18n.locale })
        .then((v) => {
          if (v && v.data) {
    ...
    <LayOut>
      <div class="project-content">
        <div class="content" ref="projectContent" v-loading="projectListLoading">
          <ProjectItem v-for="item of projectList" :content="item" :key="item.id" :handleClickTitle="toDetailPage"></ProjectItem>
        </div>
