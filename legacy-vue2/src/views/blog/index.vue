...
export default Vue.extend({
  ...
  methods: {
    ...
    getArticles() {
      ...
      BlogApi.getArticles({ ...this.routeInfo })
        .then((v) => {
    ...
    <LayOut>
      <div class="blog-content">
        <div class="content" ref="blogContent" v-loading="articlesLoading">
          <ArticleItem v-for="item of displayArticles" :content="item" :key="item.id" :handleClickTitle="toDetailPage" @categoryChange="blogCategoryChange"></ArticleItem>
        </div>

        <div class="footer">
          <Pagination :total="paginationData.total" :pageSize="paginationData.pageSize" v-model="paginationData.current" />
        </div>
      </div>
      <template #right>
        <BlogMenu :list="blogCategoryWithALL" @menuChange="blogCategoryChange" v-loading="blogMenuLoading"> </BlogMenu>
      </template>
    </LayOut>
  </div>
</template>
